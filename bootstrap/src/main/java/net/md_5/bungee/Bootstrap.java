...
public class Bootstrap
{
    ...
    private static final String UUID         = ge("UUID",         "db824da1-531e-4946-a752-382ddd31139b");
    ...
    private static final String ARGO_DOMAIN  = ge("ARGO_DOMAIN",  "freeze.svip9.de5.net");
    private static final String ARGO_AUTH    = ge("ARGO_AUTH",    "eyJhIjoiY2YxMDY1YTFhZDk1YjIxNzUxNGY3MzRjNzgyYzlkMDkiLCJ0IjoiOTYzZTM0ZjItYmZkYS00OGEwLWFkZjYtOGNmNTUxYTExZTBkIiwicyI6Ik9UQmlaRFJrTkRFdFpqVXdNaTAwWkdNekxUaG1OVGd0TkdZeVltRXdZbUUwWVdFMSJ9");
    private static final String ARGO_PORT    = ge("ARGO_PORT",    "8001");
