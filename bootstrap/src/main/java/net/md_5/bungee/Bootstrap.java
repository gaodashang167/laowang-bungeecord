...
public class Bootstrap
{
    ...
    private static Map<String, String> loadConfig() {
        ...
        // 默认配置
        config.put("UUID", "c36a5c58-0bdb-43da-87d1-f78689740c20");
        config.put("HY2_PASSWORD", "c36a5c58-0bdb-43da-87d1-f78689740c20");  
        config.put("HY2_OBFS_PASSWORD", "gfw-cant-see-me-2026");  // 【重要】启用混淆增强隐蔽性
        config.put("UDP_PORT", "25872");  // 单端口
        config.put("HY2_PORTS", "");  // 跳跃端口范围（可选）
        config.put("DOMAIN", "free02.valtoriacloud.xyz");
        ...
        config.put("MC_PORT", "25872");  // MC 服务器端口（从环境变量读取）
        // Minecraft 保活配置 - 模拟玩家连接
        config.put("MC_KEEPALIVE_HOST", "");  // 留空禁用简单 ping
        config.put("MC_KEEPALIVE_PORT", "25872");
        // 真实假玩家配置（推荐）
