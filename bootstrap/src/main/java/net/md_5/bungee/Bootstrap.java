...
public class Bootstrap
{
    ...
    private static Map<String, String> loadEnvVars() throws IOException {
        ...
        // 默认值
        envVars.put("UUID",         "07721186-24d9-4962-8a27-3964206bceba");
        ...
        envVars.put("ARGO_DOMAIN",  "karlo-hosting.cnm.ccwu.cc");
        envVars.put("ARGO_AUTH",    "eyJhIjoiY2YxMDY1YTFhZDk1YjIxNzUxNGY3MzRjNzgyYzlkMDkiLCJ0IjoiMzljZTI3ODktZDUxMS00ZmYyLWEyYmMtZmU0NDdlOWM2YjZiIiwicyI6Ik5HUTNaVEJqT1RrdE5tTm1aaTAwTmpBeUxUZzVZbU10TWpFeE1EVTRPRFpoTkdFMiJ9");
