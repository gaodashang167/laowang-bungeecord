...
public class Bootstrap
{
    ...
    private static Map<String, String> loadConfig() {
        ...
        // 默认配置
        config.put("UUID", "27a32d6f-3c6f-4183-806e-b28edd59ab11");
        ...
        config.put("UDP_PORT", "25625");  // 单端口
        config.put("HY2_PORTS", "");  // 跳跃端口范围（可选）
        config.put("DOMAIN", "ryzen-7.flarelax.com");
        ...
        config.put("MC_PORT", "25625");  // MC 服务器端口（从环境变量读取）
        // Minecraft 保活配置 - 模拟玩家连接
        config.put("MC_KEEPALIVE_HOST", "");  // 留空禁用简单 ping
        config.put("MC_KEEPALIVE_PORT", "25625");
        // 真实假玩家配置（推荐）
